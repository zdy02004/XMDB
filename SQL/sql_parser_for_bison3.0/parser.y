...
void yyerror(YYLTYPE* yylloc, ParseResult* p,yyscan_t scanner ,char* s,...);
...
/* used by the expression that use range value, e.g. between and */
 arith_expr:
  ...
  | arith_expr '+' arith_expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_ADD, 2, $1, $3); */   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_ADD,  $1, $3);}
  | arith_expr '-' arith_expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_MINUS, 2, $1, $3); */ malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_MINUS,$1, $3);}
  | arith_expr '*' arith_expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_MUL, 2, $1, $3); */   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_MUL,  $1, $3);}
  | arith_expr '/' arith_expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_DIV, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_DIV,  $1, $3);}
  | arith_expr '%' arith_expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_REM, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_REM,  $1, $3);}
  | arith_expr '^' arith_expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_POW, 2, $1, $3); */   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_POW,  $1, $3);}
  | arith_expr MOD arith_expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_MOD, 2, $1, $3); */   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_MOD,  $1, $3);}
...
expr:
  ...
  | expr '+' expr     { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_ADD, 2, $1, $3);*/   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_ADD, $1,$3); } 
  | expr '-' expr     { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_MINUS,2, $1, $3);*/  malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_MINUS, $1,$3); }
  | expr '*' expr     { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_MUL, 2, $1, $3);*/   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_MUL, $1,$3); }
  | expr '/' expr     { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_DIV, 2, $1, $3);*/   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_DIV, $1,$3); }
  | expr '%' expr     { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_REM, 2, $1, $3);*/   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_REM, $1,$3); }
  | expr '^' expr     { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_POW, 2, $1, $3);*/   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_POW, $1,$3); }
  | expr MOD expr     { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_MOD, 2, $1, $3);*/   malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_MOD, $1,$3); }
  | expr COMP_LE expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_LE, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_LE, $1,$3); }
  | expr COMP_LT expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_LT, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_LT, $1,$3); }
  | expr COMP_EQ expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_EQ, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_EQ, $1,$3); }
  | expr COMP_GE expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_GE, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_GE, $1,$3); }
  | expr COMP_GT expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_GT, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_GT, $1,$3); }
  | expr COMP_NE expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_NE, 2, $1, $3);*/    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_NE, $1,$3); }
  | expr LIKE expr { /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_LIKE, 2, $1, $3); */    malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_LIKE, $1,$3); }
  ...
  | expr AND expr %prec AND
    {
      ...
      malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_AND, $1,$3);
    }
  | expr OR expr %prec OR
    {
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_OR, 2, $1, $3);*/
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_OR, $1,$3);

    }
  | NOT expr
    {
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_NOT, 1, $2);*/
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_NOT, $2);

    }
  | expr IS NULLX
    {
     /* malloc_non_terminal_node($$, result->malloc_pool_, T_OP_IS, 2, $1, $3);*/
      malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_IS, $1,$3);
    }
  | expr IS NOT NULLX
    {
     /* malloc_non_terminal_node($$, result->malloc_pool_, T_OP_IS_NOT, 2, $1, $4);*/
     malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_IS_NOT, $1,$4);
  ...
  | expr BETWEEN arith_expr AND arith_expr	    %prec BETWEEN
    {
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_BTW, 3, $1, $3, $5);*/
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_BTW, $1,$3,$5);

    }
  | expr NOT BETWEEN arith_expr AND arith_expr	  %prec BETWEEN
    {
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_NOT_BTW, 3, $1, $4, $6);*/
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_NOT_BTW, $1,$4,$6);
  
    }
  | expr IN in_expr
    {
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_IN, 2, $1, $3);*/
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_IN, $1,$3);

    }
  | expr NOT IN in_expr
    {
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_NOT_IN, 2, $1, $4);*/
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_NOT_IN, $1,$4);

    }
  | expr CNNOP expr
    {
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_OP_CNN, 2, $1, $3);*/
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_OP_CNN, $1,$3);
    ...
    CASE case_arg when_clause_list case_default END
    {
      ...
      /*malloc_non_terminal_node($$, result->malloc_pool_, T_CASE, 3, $2, $$, $4);*/
       // merge_nodes($$, result->Doc.GetAllocator(),T_WHEN_LIST, $3);
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_CASE,  $2, $$, $4);
...
when_clause:
  	WHEN expr THEN expr
    {
      ...
      malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_WHEN,  $2, $4);
...
func_expr:
    function_name '(' '*' ')'
    {
      if (strcasecmp((*$1)["str_value_"].GetString(), "count") != 0)
      {
      ...
      else
      {
        ...
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_COUNT, 1, node);*/
      	 rapidjson::Value * node;
      	 malloc_terminal_node(node, result->Doc.GetAllocator(),  T_STAR)
         malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_COUNT, node);
  ...
  | function_name '(' distinct_or_all expr ')'
    {
      if (strcasecmp((*$1)["str_value_"].GetString(), "count") == 0)
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_COUNT, 2, $3, $4);*/
         malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_COUNT, $3, $4);

      }
      else if (strcasecmp((*$1)["str_value_"].GetString(), "sum") == 0)
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_SUM, 2, $3, $4);*/
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_SUM, $3, $4);

      }
      else if (strcasecmp((*$1)["str_value_"].GetString(), "max") == 0)
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_MAX, 2, $3, $4);*/
         malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_MAX, $3, $4);
      }
      else if (strcasecmp((*$1)["str_value_"].GetString(), "min") == 0)
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_MIN, 2, $3, $4);*/
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_MIN, $3, $4);

      }
      else if (strcasecmp((*$1)["str_value_"].GetString(), "avg") == 0)
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_AVG, 2, $3, $4);*/
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_AVG, $3, $4);
  ...
  | function_name '(' expr_list ')'
    {
      if (strcasecmp((*$1)["str_value_"].GetString(), "count") == 0)
      {
        ...
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_COUNT, 2, NULL, $3);*/
         malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_COUNT, NULL, $3);
      ...
      else if (strcasecmp((*$1)["str_value_"].GetString(), "sum") == 0)
      {
        ...
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_SUM, NULL, $3);
      ...
      else if (strcasecmp((*$1)["str_value_"].GetString(), "max") == 0)
      {
       ...
       malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_MAX, NULL, $3);
      ...
      else if (strcasecmp((*$1)["str_value_"].GetString(), "min") == 0)
      {
        ...
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_MIN, NULL, $3);
      ...
      else if (strcasecmp((*$1)["str_value_"].GetString(), "avg") == 0)
      {
        ...
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_AVG, NULL, $3);

      }
      else if (strcasecmp((*$1)["str_value_"].GetString(), "trim") == 0)
      {
        if ((*$3)["type_"].GetInt() == T_LINK_NODE)
        {
      ...
      else  /* system function */
      {
        ...
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_SYS, 2, $1, params);*/
         ...
         malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_SYS, $1, params);
  ...
  | function_name '(' expr AS data_type ')'
    {
      if (strcasecmp((*$1)["str_value_"].GetString(), "cast") == 0)
      {
  ...
  | function_name '(' parameterized_trim ')'
    {
      ...
      malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_SYS, $1, $3);

    }
  | function_name '(' ')'
    {
      if (strcasecmp((*$1)["str_value_"].GetString(), "now") == 0 ||
          strcasecmp((*$1)["str_value_"].GetString(), "current_time") == 0 ||
          strcasecmp((*$1)["str_value_"].GetString(), "current_timestamp") == 0)
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_CUR_TIME, 1, $1);*/
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_CUR_TIME, $1);

      }
      else if (strcasecmp((*$1)["str_value_"].GetString(), "strict_current_timestamp") == 0)
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_CUR_TIME_UPS, 1, $1);*/
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_CUR_TIME_UPS, $1);

      }
      else
      {
        /*malloc_non_terminal_node($$, result->malloc_pool_, T_FUN_SYS, 1, $1);*/
        malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_FUN_SYS, $1);
...
when_func_name:
    ROW_COUNT
    {
     ...
     malloc_non_terminal_node(&$$, result->Doc.GetAllocator(), T_ROW_COUNT, NULL);
  ...
  | select_clause order_by opt_for_update
    {
      ...
      */
      rapidjson::Value  select;
      	...
      	if (select.HasMember("later_select") && $2 ) {select.RemoveMember("later_select");select.AddMember("later_select",*$2,result->Doc.GetAllocator());}
  ...
  | select_clause opt_order_by select_limit opt_for_update
    {
      ...
      */
      ...
      {
      	if (select.HasMember("later_select") && $2) {select.RemoveMember("later_select");select.AddMember("later_select",*$2,result->Doc.GetAllocator());}
      	else if($2) select.AddMember("later_select",*$2,result->Doc.GetAllocator());
      }	
     if ( select.HasMember("order_by") && $3 ){select.RemoveMember("order_by");select.AddMember("order_by",*$3,result->Doc.GetAllocator());}
     if ( select.HasMember("limit") )	{select.RemoveMember("limit");} 
     if($4)select.AddMember("limit",*$4,result->Doc.GetAllocator());
     $$->Swap(select);
    }
  ;
...
no_table_select:
  ...
  | SELECT opt_hint opt_distinct select_expr_list
    FROM DUAL opt_where opt_select_limit
    {
      ...
      SafeAddMember($$,"distinct",$3,result->Doc.GetAllocator());
      SafeAddMember($$,"select_clause",project_list,result->Doc.GetAllocator());
      SafeAddMember($$,"where",$7,result->Doc.GetAllocator());
...
simple_select:
    ...
    opt_where opt_groupby opt_having
    {
      ...
      SafeAddMember($$,"from_clause",from_list,result->Doc.GetAllocator());
			SafeAddMember($$,"where",$7,result->Doc.GetAllocator());
			SafeAddMember($$,"group_by",$8,result->Doc.GetAllocator());
			SafeAddMember($$,"having",$9,result->Doc.GetAllocator());
			SafeAddMember($$,"hints",$2,result->Doc.GetAllocator());
    }
...
projection:
    expr
    {
     /* malloc_non_terminal_node($$, result->malloc_pool_, T_PROJECT_STRING, 1, $1);
      ...
      malloc_non_terminal_node(&$$,result->Doc.GetAllocator(),T_PROJECT_STRING,$1);
       // dup_expr_string
...
joined_table:
  ...
  | table_factor join_type JOIN table_factor ON expr
    {
     ...
     malloc_non_terminal_node(&$$,result->Doc.GetAllocator(), T_JOINED_TABLE, $2, $1, $4, $6);
  ...
  | table_factor JOIN table_factor ON expr
    ...
    malloc_non_terminal_node(&$$,result->Doc.GetAllocator(), T_JOINED_TABLE,  node, $1, $3, $5);
    }
  ;
...
const char *sql_str = ""
    ...
    "from (select * from table_1 where condition > 1) o, table_2 "
    "where table_1.user_id = table_2.user_id and table_1.user_id = 12 ";
    //"select qty1, user_name2,ddd3   "
   // "from table_name o ";
    //"where o.user_id = 1 ";
