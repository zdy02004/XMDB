...
if(0!=(err=mem_rbtree_insert(mem_rbtree_index, mem_rbtree_index->root,&index1))){ERROR("mem_rbtree_insert err1 is %d\n",err);return;}
if(0!=(err=mem_rbtree_insert(mem_rbtree_index, mem_rbtree_index->root,&index2))){ERROR("mem_rbtree_insert err2 is %d\n",err);return;}
if(0!=(err=mem_rbtree_insert(mem_rbtree_index, mem_rbtree_index->root,&index3))){ERROR("mem_rbtree_insert err3 is %d\n",err);return;}
if(0!=(err=mem_rbtree_insert(mem_rbtree_index, mem_rbtree_index->root,&index5))){ERROR("mem_rbtree_insert err4 is %d\n",err);return;}
if(0!=(err=mem_rbtree_insert(mem_rbtree_index, mem_rbtree_index->root,&index6))){ERROR("mem_rbtree_insert err5 is %d\n",err);return;}


mem_rbtree_entry_t * index4;
mem_rbtree_entry_t * index11;

if(0!=(err=mem_rbtree_search(mem_rbtree_index, mem_rbtree_index->root,3,&index4))){ERROR("mem_rbtree_search err6 is %d\n",err);;return;}
if(0!=(err=mem_rbtree_delete(mem_rbtree_index, mem_rbtree_index->root,   index4))){ERROR("mem_rbtree_delete err7 is %d\n",err);;return;}
