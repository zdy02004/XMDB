...
//建skiplist配置信息
if(0!=(err=create_mem_skiplist_config(&skiplist_config,2048,"./first_index_name\0",4)))DEBUG("mem_table_create err is %d\n",err);
//建跳表索引
...
//if(0!=(mem_skiplist_insert(mem_skiplist_index, NULL,3,&index2))){ERROR("mem_skiplist_insert err2 is %d\n",err);return err;}
//if(0!=(mem_skiplist_insert(mem_skiplist_index, NULL,3,&index3))){ERROR("mem_skiplist_insert err3 is %d\n",err);return err;}
//if(0!=(mem_skiplist_insert(mem_skiplist_index, NULL,3,&index5))){ERROR("mem_skiplist_insert err4 is %d\n",err);return err;}
//if(0!=(mem_skiplist_insert(mem_skiplist_index, NULL,3,&index6))){ERROR("mem_skiplist_insert err5 is %d\n",err);return err;}


//mem_skiplist_entry_t * index4;
//mem_skiplist_entry_t * index11;
